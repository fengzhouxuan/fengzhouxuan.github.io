---
title: "Unity 中网格是如何绘制的（二）"
date: 2022-09-03 22:12:22 +0800
updated: 2022-09-03 22:12:22 +0800
permalink: /posts/unity-mesh-rendering-2/
categories:
  - "Unity"
tags:
  - "Unity"
...
> 本文迁移自旧站，保留当时的学习记录；涉及版本与实践结论的内容会在后续复查中逐步更新。
上文 [Unity中网格是如何绘制的(一)](/posts/unity-mesh-rendering-1/) 讲了绘制网格的基础知识，并绘制了一个三角形面，这次绘制一个矩形面片，如图：

![矩形面片](/images/legacy/unity/unity-mesh-3.png)
...
![矩形面片](/images/legacy/unity/unity-mesh-4.jpg)

因为共用了顶点，所以只有4条法线

那么不共用顶点会是什么效果

![矩形面片](/images/legacy/unity/unity-mesh-5.png)
